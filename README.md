...
|----------|--------|-------|
| Участник 1 | Server Core (Sockets, Threads) | `feature/server-core` |
| Участник 2 | Database Layer (JDBC, MySQL) | `feature/database` |
| Участник 3 | Client Network (Sockets, Protocol) | `feature/client-network` |
| Участник 4 | GUI (JavaFX, FXML) | `feature/javafx-gui` |
...
Учебный проект. Только для использования в образовательных целях.
